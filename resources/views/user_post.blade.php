			...
			<div class="">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li>
							<a href="{{URL::to('/analysis')}} "class="dropdown-toggle no-arrow">
...
@endif
					...
					<div class="html-editor pd-20 card-box mb-30">
						<h4 class="h4 text-blue">Create a post</h4>
					...
					<form method="POST"  action="/sendpost" >
						...
						placeholder="Enter text ..." id="textareavalue" name="tweets"
						>

				</textarea>
				<button type="submit"  class="btn btn-primary" style="float: right; width:120px;top:40px" id="textareavalue" >Post</button>
				<button class="btn btn-primary" style="float: right; margin-right:20px;width:120px;" >Sechadule</button>
						</form>
				...
				<div class="html-editor pd-20 card-box mb-30">
					<h4 class="h4 text-blue">Show the post</h4>
					<script src="https://apps.elfsight.com/p/platform.js" defer></script>
<div class="elfsight-app-d62684af-5169-460f-99e6-12422c58dc65"></div>
					</div>
